...
- Criterio de clips (skill `elegir-clips`): cada clip es un arco COMPLETO standalone — contexto + reacción + remate, 1-6 spans con los momentos que dicen algo (silencios/baches se saltean, el montaje los elimina); si lee comentarios, incluir el necesario para entender la respuesta; cola ~2s tras la última palabra (o outro mínima en Shotcut). Sin tope 59s salvo 180s de Shorts.
