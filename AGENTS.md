...
- Posición STANDARD EP2 (layout fijo: video vertical + cam con título; recalcular por video si cambia): V1 crop `left=660 top=0 right=660 bottom=35` + affine `0 20 1080 1881` (encuadre completo del video reaccionado x660-1260 y0-1045); V2-cam crop `left=1632 top=48 right=51 bottom=687` (título CHITRULO + caja al borde cyan, sin gris) + affine `760 20 300 437` (PiP arriba-derecha).
